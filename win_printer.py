...
def get_printer_config(printer_handle):
    config = {
        ...
        'PHYSICALOFFSETX': win32print.GetDeviceCaps(printer_handle, win32con.PHYSICALOFFSETX),
        'PHYSICALOFFSETY': win32print.GetDeviceCaps(printer_handle, win32con.PHYSICALOFFSETY),
